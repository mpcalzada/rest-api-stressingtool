...
import com.ks.client.auth.ApiKeyAuth;
import com.ks.client.auth.Authentication;
import com.ks.client.auth.HttpBasicAuth;
import com.ks.client.auth.OAuth;
...
public class ApiClient
{
    ...
    private String basePath = "https://10.21.94.130/ks/km-switch/2.0.0.2";
    ...
    public ApiClient()
    {
        ...
        httpClient.setConnectTimeout(40000, TimeUnit.MILLISECONDS);
        httpClient.setReadTimeout(40000, TimeUnit.MILLISECONDS);
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://10.21.94.130/ks/km-switch/2.0.0.2
